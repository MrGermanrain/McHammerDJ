                    ...
                    <div class="row">
                        <div class="col-md-12">
                                    ...
                                    <div class="row stacked">
                                        <div class="col-md-6">
                                            <div class="input-group push-down-10">
                                                ...
                                                <input type="text" class="form-control" placeholder="Keywords..." value="Joli Admin admin template"/>
                                                <div class="input-group-btn">
                                                    <button class="btn btn-primary">Search</button>
                                                </div>
                                            </div>                                                                
                                            
                                            <span class="line-height-30">Search Results for <strong>Joli Admin admin template</strong> (3,877 results)</span>
                            ...
                            <div class="search-results">
                                ...
                                <div class="sr-item">
                                    <a href="#" class="sr-item-title">Joli Admin - Responsive Bootstrap Admin Template</a>
                                ...
                                <div class="sr-item">
                                    ...
                                    <div class="sr-item-link">http://themifycloud.com/downloads/free-responsive-bootstrap-joli-angular-js-admin-template-dashboard-web-app/</div>
                                    <p>Duis aliquet condimentum aliquet. Morbi finibus nisi vitae volutpat interdum. Pellentesque sed nisi mauris. Donec <strong>Joli Admin</strong> mattis efficitur mi. Morbi mauris enim, cursus in elit in, facilisis imperdiet metus</p>
                                    <p class="sr-item-links"><a href="#">Translate this page</a> - <a href="#">View cache</a> - <a href="#">Remove from search</a></p>
                                </div>
                                ...
                                <div class="sr-item">
                                    ...
                                    <p>Search Results for <strong>Joli Admin admin template</strong> in Files Store: <strong>75</strong>.</p>
                                ...
                                <div class="sr-item">
                                    <div class="sr-item-title">Images available on request <a href="pages-gallery.php" class="btn btn-primary btn-rounded pull-right"><span class="fa fa-image"></span> Open gallery</a></div>                                    
                                    <div class="sr-item-link">Dashboard <span class="fa fa-angle-right"></span> Pages <span class="fa fa-angle-right"></span> Gallery</div>
                                    <p>Search Results for <strong>Joli Admin admin template</strong> in Gallery: <strong>195</strong> jpeg images.</p>
                                    ...
                                    <p class="sr-item-links"><a href="pages-gallery.php">More pictures on request <strong>Joli Admin admin template</strong></a></p>
                                </div>
                                ...
                                <div class="sr-item">
                                    ...
                                    <p>Search Results for <strong>Joli Admin admin template</strong> in Address Book: <strong>43</strong> contacts.</p>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="row">
                                    ...
                                    <p><a href="pages-address-book.php" class="btn btn-primary btn-rounded"><span class="fa fa-book"></span> Open Address Book</a></p>
                                </div>                                
