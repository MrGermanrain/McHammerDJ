...
{
    $del=$_GET['del'];
    $sql=mysql_query("DELETE FROM hero WHERE `id`='$del'");
                                ...
                                <div class="panel-body">
                                    <table id="customers2" class="table datatable">
                                        ...
                                        <tbody>
                                            ...
                                            $sql=mysql_query("SELECT * FROM `hero`");
                                            ...
                                            <?php }} ?>
                                                ...
                                                <td><i class="fa fa-trash-o">&nbsp<a href="hero.php?del=<?php echo $row['id']; ?>">Delete</a></i></td>
                                            </tr>
                                            <?php }} ?>
